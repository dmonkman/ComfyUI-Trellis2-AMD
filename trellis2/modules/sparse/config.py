...
def __from_env():
    ...
    if env_sparse_attn_backend is not None and env_sparse_attn_backend in ['xformers', 'flash_attn', 'flash_attn_3', 'aule']:
...
def set_attn_backend(backend: Literal['xformers', 'flash_attn', 'flash_attn_3', 'aule']):
    global ATTN
    ATTN = backend
